      ...
      <div className="flex items-center justify-center p-8" style={{ backgroundColor: 'var(--surface)' }}>
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {error && (
              <div className="p-3 text-sm text-red-400 bg-red-950/20 border border-red-900/30 rounded-lg" style={{ marginBottom: '24px' }}>
                {error}
              </div>
            )}
          ...
          {/* Sign Up Link */}
          <div className="text-center text-sm text-muted-foreground" style={{ marginTop: '40px' }}>
